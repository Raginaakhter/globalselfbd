...
export default function PromoBanner() {
  ...
  return (
    <section id="clearance" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 scroll-mt-32">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-navy-700 via-navy-600 to-brand-700 text-white shadow-xl">
        <div className="absolute -left-10 -top-10 w-56 h-56 rounded-full bg-brand-400/20 blur-2xl" />
        <div className="absolute right-0 bottom-0 text-[10rem] leading-none opacity-15 select-none">🎁</div>
